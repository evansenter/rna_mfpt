...
double compute_mfpt(KLP_MATRIX*, const MFPT_PARAMETERS, const double*);
double* inverse(double*, int);
double* pseudoinverse(double*, int);
int find_start_and_end_positions_in_klp_matrix(KLP_MATRIX*, const MFPT_PARAMETERS, int*, int*);
void set_bp_dist_from_start_and_end_positions(const KLP_MATRIX, MFPT_PARAMETERS*, int, int, int);
...
double transition_rate_from_probabilities_with_hastings(const KLP_MATRIX, const double*, int, int);
double transition_rate_from_energies_with_hastings(const KLP_MATRIX, const double*, int, int);
double transition_rate_from_radial_probability(const KLP_MATRIX, const double*, int, int);
